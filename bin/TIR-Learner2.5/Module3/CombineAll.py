...
#
f_m1=removeDupinSingle("%s.gff3"%(genome_Name+spliter+"Module1"))
f_m2=removeDupinSingle("%s.gff3"%(genome_Name+spliter+"Module2"))
...
f_final=removeDupinSingle("%scombined.gff3"%(genome_Name+spliter))
f_final.to_csv("%s_FinalAnn.gff3"%(genome_Name),header=None,index=None,sep="\t")
