...
mkdir $genome.combine.EDTA_process_C2
cd $genome.combine.EDTA_process_C2

# make softlinks to input files
...
# remove LTR in TIR.stg0.HQ
RepeatMasker -pa $threads -q -no_is -norna -nolow -div 40 -lib $genome.LTR.fa.stg0.HQ $genome.TIR.fa.stg0.HQ
perl ~/las/git_bin/TElib_benchmark/util/cleanup_tandem.pl -misschar N -nc 50000 -nr 0.9 -minlen 80 -minscore 3000 -trf 0 -cleanN 1 -cleanT 1 -f $genome.TIR.fa.stg0.HQ.masked > $genome.TIR.fa.HQ.stg1
...
cat $genome.LTR.fa.stg0.HQ $genome.TIR.fa.HQ.stg1 > $genome.LTR.TIR.fa.stg0.HQ
